<%-- 
    Document   : DEVENDRA_SIR
    Created on : Dec 18, 2021, 3:21:52 AM
    Author     : Harsh Deep
--%>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MR. DEVENDRA SINGH BHARANGAR (LECTURER)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
                                    <td style="text-align:center"><b>Qualification :- B.E.(I.T.), M.E.(C.S.E.)</b> </td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Experiance :- 17 years</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Mail :- devendra23@hotmail.com</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Area of Specialization :- Software Engineering,Computer Networks,Network Security,Data Structure Using C </b></td>
                                </tr>
                            </tbody>
                        </table>  
                    </div>
