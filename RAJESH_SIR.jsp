<%-- 
    Document   : RAJESH_SIR
    Created on : Dec 19, 2021, 10:17:21 PM
    Author     : Harsh Deep
--%>
    ...
    <body>
        ...
        <div class="container" >
            <div class="row">
                ...
                <div class="col-sm-10">
                    <h2 style="text-align: center;border-bottom: 2px solid black;font-family: serif;margin-bottom:40px"><b>NON-TEACHNIG STAFF</b></h2>
                </div>   
                <div class="col-sm-1"></div>   
            </div> 
            </div>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MR. RAJESH KUMAR SHARMA (Instructor Workshop)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
