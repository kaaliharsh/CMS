<%-- 
    Document   : RAJKUMAR_SIR
    Created on : Dec 19, 2021, 10:20:19 PM
    Author     : Harsh Deep
--%>
    ...
    <body>
        ...
        <div class="container" >
            <div class="row">
                ...
                <div class="col-sm-10">
                    <h2 style="text-align: center;border-bottom: 2px solid black;font-family: serif;margin-bottom:40px"><b>LECTURER ENGLISH</b></h2>
                </div>   
                <div class="col-sm-1"></div>   
            </div> 
            </div>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MR. RAJ KUMAR SINGH</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
                                    <td style="text-align:center"><b>Qualification :- M.A.(ENGLISH) , B.Ed.</b> </td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Experiance :- 12 YEARS </b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>E-Mail :- rajkumarsingh351@gmail.com</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Area of Specialization:- Very Good command in Communication Skill & Eng. Grammar</b></td>
                                </tr>
                            </tbody>
                        </table>  
                    </div>
