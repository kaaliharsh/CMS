<%-- 
    Document   : NIDHI_MAM
    Created on : Dec 19, 2021, 9:57:36 PM
    Author     : Harsh Deep
--%>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MS. NIDHI VARSHNEY (LECTURER)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
                                    <td style="text-align:center"><b>Qualification :- B.TECH </b> </td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Experiance :- 14+ YEARS</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>E-Mail :- nidhi.emerson@gmail.com</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Area specialization :- ELECTRONICS AND COMMUNICATION </b></td>
                                </tr>
                            </tbody>
                        </table>  
                    </div>
