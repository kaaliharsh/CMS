<%-- 
    Document   : SHALU_SIR
    Created on : Dec 19, 2021, 9:54:39 PM
    Author     : Harsh Deep
--%>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MR. SHALU SAINI (LECTURER)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
                                ...
                                <tr class="success">
                                    <td style="text-align: center"><b>E-Mail :- sameersaini2468@gmail.com</b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Area of specialization :- Electronics Engineering  </b></td>
                                </tr>
                            </tbody>
                        </table>  
                    </div>
