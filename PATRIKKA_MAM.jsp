<%-- 
    Document   : PATRIKKA_MAM
    Created on : Dec 19, 2021, 9:57:10 PM
    Author     : Harsh Deep
--%>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MRS. PATRIKA JAYANTI (LECTURER)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="success">
                                    <td style="text-align:center"><b>Qualification :- B.Tech , M.Tech </b> </td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>Experiance :- 11+ Years </b></td>
                                </tr>
                                <tr class="success">
                                    <td style="text-align: center"><b>E-Mail :- @gmail.com</b></td>
                                </tr>
                                <tr class="success">
                                 <td style="text-align: center">
                                     <b>Area of specialization :- Electronics and communications  </b>
                                 </td>
                                </tr>
                            </tbody>
                        </table>  
