<%-- 
    Document   : SANDEEP_SIR
    Created on : Mar 01, 2022, 12:30:46 AM
    Author     : Harsh Deep
--%>
                ...
                <div class="col-sm-7" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        <table style="box-shadow: 1px 2px 4px 1px #193347;width:100%" class="table table-hover" border="1" class="table table-responsive">
                            <thead>
                                <tr class="success">
                                    <th style="text-align: center"><h4><b>MR. SANDEEP SHARMA <br>(LECTURER)</b></h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="success">
                                    <td style="text-align: center"><b>Experiance :- 10 years </b></td>
                                </tr>
                                
                                
                                <tr class="success">
                                    <td style="text-align: center"><b>E-Mail :- sndp.sharma01@gmail.com</b></td>
                                </tr>
